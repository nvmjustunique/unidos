      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => KalaraagPage()),
            );
          },
...
class KalaraagPage extends StatelessWidget {
  const KalaraagPage({super.key});
                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        "assets/images/kalaraag.jpg"), // Add a profile picture
                  ),
                  SizedBox(width: 16),
                  // User Info
                  Column(
